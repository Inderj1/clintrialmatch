    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
        ...
        <div>
          ...
          <ul class="space-y-3">
            <li><a href="/crops" class="hover:text-white transition-colors">Biological Control</a></li>
            <li><a href="/crops" class="hover:text-white transition-colors">Natural Pollination</a></li>
            <li><a href="/crops" class="hover:text-white transition-colors">Monitoring Systems</a></li>
            <li><a href="/crops" class="hover:text-white transition-colors">Technical Support</a></li>
          </ul>
        </div>
